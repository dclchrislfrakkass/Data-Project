...
foreach($csv as $ligne){
    ...
    $NomduDepartement = addslashes($ligne[6]);
    $RegionEtude = addslashes($ligne[7]);
    ...
    $rqt ="INSERT INTO ufo(NumEtude,NomEtude,Latitude,Longitude,DateObservationEtude,DepartementEtude,NomduDepartement,RegionEtude,ResumeWeb,ResumeLong,Nomclassification,DateModification) VALUES ($ligne[0]','$ligne[1]', '$ligne[2]', '$ligne[3]', '$ligne[4]', '$ligne[5]', '$NomduDepartement', '$RegionEtude', '$ResumeWeb', '$ResumeLong', '$ligne[13]','$ligne[14]')";
